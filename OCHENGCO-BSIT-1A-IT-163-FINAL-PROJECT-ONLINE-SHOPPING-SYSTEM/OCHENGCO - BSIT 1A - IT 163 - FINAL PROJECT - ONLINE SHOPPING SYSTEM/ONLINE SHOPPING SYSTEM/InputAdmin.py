...
def prodName(prod_storage):
    ...
    while True:
        ...
        prod_name_input = input("\033[1A\033[KEnter Product Name: ")
...
def prodPrice():
    ...
    while True:
        try:
            prod_price_input = float(input("\033[1A\033[KEnter Product Price: "))
...
def prodStock():
    ...
    while True:
        try:
            prod_stock_input = int(input("\033[1A\033[KAdd Product Stock: "))
