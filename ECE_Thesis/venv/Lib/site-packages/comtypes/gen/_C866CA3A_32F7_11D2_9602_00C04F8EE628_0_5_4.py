...
__all__ = [
    'SPPHRASEELEMENT', 'eLEXTYPE_PRIVATE9', 'DISPID_SVEViseme',
    'SREPhraseStart', 'DISPID_SpeechRecoContext', 'SPCONTEXTSTATE',
    'SVP_0', 'SPAS_PAUSE', 'ISpeechTextSelectionInformation',
    'ISpeechPhraseReplacements', 'SSFMCreateForWrite', 'SVP_14',
    'DISPIDSPTSI', 'DISPID_SpeechPhraseBuilder', 'SPWORD',
    'DISPID_SRCEStartStream', 'SPAR_High', 'SpeechAudioFormatType',
    'SPEI_PHRASE_START', 'SpeechTokenKeyFiles',
    'DISPID_SRAudioInputStream', 'DISPID_SPCIdToPhone', 'SPPHRASE',
    'SP_VISEME_9', 'SpTextSelectionInformation', 'SPLO_STATIC',
    'SPCT_SLEEP', 'SpMMAudioIn', 'LONG_PTR', 'SVSFNLPMask',
    'SVPAlert', 'DISPID_SRRRecoContext', 'DISPID_SGRSTPropertyValue',
    'SPAO_RETAIN_AUDIO', 'ISpObjectToken', 'DISPID_SRCEBookmark',
    'SPRECOGNIZERSTATUS', 'DISPID_SVWaitUntilDone', 'DISPID_SRCVoice',
    'SDTDisplayText', 'SDKLLocalMachine', 'SECHighConfidence',
    'DISPID_SMSALineId', 'SVSFUnusedFlags', 'SPEI_REQUEST_UI',
    'DISPID_SRRTimes', 'DISPID_SPAPhraseInfo', 'SRARoot',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechLexiconProns',
    'SpeechTokenKeyAttributes', 'DISPID_SRCResume', 'SGRSTTDictation',
    'SRERecognition', 'SGDSInactive', 'SpLexicon',
    'SpeechPropertyNormalConfidenceThreshold', 'SpInprocRecognizer',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SOTCSetId',
    'SAFT44kHz16BitStereo', 'DISPID_SOTGetStorageFileName',
    'SPEI_FALSE_RECOGNITION', 'Speech_Max_Pron_Length',
    'DISPID_SPPFirstElement', 'SpeechRecoProfileProperties',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRAudioInput',
    'SpeechRetainedAudioOptions', 'DISPID_SRIsUISupported',
    'ISpeechObjectTokens', 'ISpeechResourceLoader',
    'eLEXTYPE_PRIVATE3', 'SVP_7', 'SpeechBookmarkOptions',
    'SPINTERFERENCE_NONE', 'DISPID_SRRPhraseInfo', 'SGRSTTWord',
    'SVP_18', 'SVP_16', 'DISPID_SVSpeakStream', 'DISPID_SPEsItem',
    'SGRSTTTextBuffer', 'SP_VISEME_12', 'SPEI_RESERVED5',
    'eLEXTYPE_PRIVATE4', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVAudioOutputStream',
    'SFTSREngine', 'SVSFIsXML', 'DISPID_SpeechGrammarRules',
    'SVSFPurgeBeforeSpeak', 'SpeechWordPronounceable',
    'ISpResourceManager', 'STSF_LocalAppData', 'SPFM_OPEN_READWRITE',
    ...
    'SpeechDisplayAttributes', 'ISequentialStream', 'SP_VISEME_6',
    'SSSPTRelativeToCurrentPosition', 'SINoise', 'DISPID_SBSWrite',
    'ISpeechLexiconWord', 'SRAImport', 'DISPID_SABIBufferSize',
    'DISPID_SLWLangId', 'SAFT16kHz8BitStereo', 'SRAInterpreter',
    'DISPID_SLWsCount', 'SGDSActiveWithAutoPause',
    'DISPID_SPEDisplayAttributes', 'SPEI_PHONEME', 'SP_VISEME_17',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SRADynamic',
    'SAFTADPCM_8kHzStereo', 'DISPID_SLRemovePronunciation',
    'DISPID_SLWType', 'SSTTDictation', 'SpeechLoadOption',
    'DISPID_SPIProperties', 'DISPID_SpeechLexiconWords',
    'SP_VISEME_21', 'SAFT16kHz8BitMono', 'SPRST_NUM_STATES',
    'DISPID_SVSCurrentStreamNumber', 'SpeechVisemeFeature',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLPsCount',
    'SpeechMicTraining', 'DISPID_SGRId', 'ISpRecoContext2',
    'SAFTNonStandardFormat', 'DISPID_SpeechPhraseProperties',
    'SVF_None', 'DISPID_SVEStreamEnd', 'SAFT48kHz8BitMono', 'SPSLMA',
    'SpeechPartOfSpeech', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPRuleFirstElement',
    'SpNotifyTranslator', 'SVF_Emphasis', 'DISPID_SRGetFormat',
    'DISPID_SRCAudioInInterferenceStatus', 'SPBO_NONE',
    'SPEI_HYPOTHESIS', 'DISPID_SRSetPropertyNumber', 'SRTEmulated',
    'SpPhoneticAlphabetConverter', 'ISpStreamFormatConverter',
    'DISPID_SGRSTNextState', 'DISPID_SWFEExtraData',
    'DISPID_SRSClsidEngine', 'DISPID_SRGCmdLoadFromResource',
    'SpeechCategoryVoices', '__MIDL_IWinTypes_0009', 'SP_VISEME_3',
    'DISPID_SABufferInfo', 'SAFT32kHz8BitMono', 'ISpeechVoiceStatus',
    'DISPID_SREmulateRecognition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPWORDPRONUNCIATIONLIST', 'ISpEventSource', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPACommit', 'SDTReplacement', 'SPAR_Low',
    'SpeechAllElements', 'SPSHORTCUTTYPE',
    'DISPID_SLAddPronunciation', 'DISPID_SRRAudio', 'SDTRule',
    'SPWT_DISPLAY', 'SpeechLexiconType', 'DISPID_SVVolume',
    'SRTSMLTimeout', 'ISpPhraseAlt', 'SVEAudioLevel',
    'DISPID_SOTCGetDataKey', 'ISpMMSysAudio', 'eLEXTYPE_RESERVED9',
    'SpStreamFormatConverter', 'DISPID_SPIGetText', 'SINoSignal',
    'SPEI_VISEME', 'SPCT_DICTATION', 'DISPID_SOTCId',
    'DISPID_SVEPhoneme', 'DISPID_SRRTOffsetFromStart',
    'SPRST_INACTIVE', 'SREHypothesis', 'SP_VISEME_5',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCERequestUI', 'SP_VISEME_2',
    'SAFT8kHz8BitMono', 'SSSPTRelativeToStart', 'SREPrivate',
    'IInternetSecurityMgrSite', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVRate',
    'DISPID_SPEs_NewEnum', 'SGSEnabled', 'DISPID_SpeechVoice',
    'SGDSActive', 'SPVOICESTATUS', 'DISPID_SADefaultFormat',
    'SRTReSent', 'DISPID_SOTDisplayUI', 'DISPID_SOTCategory',
    'SPEI_SR_RETAINEDAUDIO', 'SVEStartInputStream',
    'DISPID_SGRsCommit', 'SpeechPropertyResponseSpeed',
    'DISPID_SPILanguageId', 'DISPID_SPIEngineId',
    'DISPID_SDKCreateKey', 'SVEWordBoundary', 'SPPHRASERULE',
    'SDTPronunciation', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SDKSetLongValue',
    'SpResourceManager', 'SVP_20', 'DISPID_SLGetPronunciations',
    'ISpeechLexicon', 'SPGRAMMARWORDTYPE', 'SPAO_NONE',
    'SWPKnownWordPronounceable', 'SPBINARYGRAMMAR', 'SITooQuiet',
    'DISPID_SRCESoundEnd', 'DISPID_SRSetPropertyString',
    'DISPID_SpeechAudio', 'SP_VISEME_7', 'SAFTDefault',
    'DISPID_SGRsItem', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCEPhraseStart', 'SPVPRIORITY',
    'SpeechCategoryPhoneConverters', 'DISPID_SRRTStreamTime',
    'ISpeechGrammarRuleState', 'tagSPTEXTSELECTIONINFO',
    'SSFMOpenForRead', 'ISpRecognizer3', 'SPEI_RESERVED2',
    'DISPID_SPISaveToMemory', 'SRESoundEnd', 'SpeechTokenShellFolder',
    'DISPID_SLPLangId', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPPParent', 'DISPID_SpeechLexicon',
    'SPEI_START_INPUT_STREAM', 'ISpeechPhraseProperties',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE13',
    'SPEI_END_SR_STREAM', 'SP_VISEME_13', 'SVSFParseSsml',
    'SP_VISEME_18', 'SECNormalConfidence', 'SPPS_LMA',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SOTId',
    'SpeechTokenKeyUI', 'DISPID_SOTCEnumerateTokens',
    'SpeechGrammarTagWildcard', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPPName', 'SPPS_NotOverriden', 'SASPause',
    'DISPID_SGRInitialState', 'SREInterference', 'SRSEDone',
    'STSF_FlagCreate', 'DISPID_SGRSTransitions', '_RemotableHandle',
    'SITooFast', 'DISPID_SVIsUISupported', 'DISPID_SVDisplayUI',
    'DISPID_SPPEngineConfidence', 'SDA_Two_Trailing_Spaces',
    'ISpeechBaseStream', 'SPBO_AHEAD', 'SECFDefault',
    'eLEXTYPE_PRIVATE19', 'SGRSTTWildcard', 'DISPID_SPEsCount',
    'SAFT24kHz16BitMono', 'SpMMAudioEnum', 'SVSFVoiceMask',
    'SpeechCategoryAppLexicons', 'DISPID_SLPType',
    'DISPID_SMSSetData', 'DISPID_SPRText', 'SPSUnknown',
    'DISPID_SLPSymbolic', 'SpStream', 'ISpeechXMLRecoResult',
    'SVSFNLPSpeakPunc', 'SPPARTOFSPEECH', 'SPEI_SOUND_END',
    'SpAudioFormat', 'DISPID_SRRDiscardResultInfo',
    'SpeechRecoContextState', 'SVEAllEvents',
    'DISPID_SpeechCustomStream', 'ISpeechAudioFormat',
    'SPSTREAMFORMATTYPE', 'SPPS_Noun', 'DISPID_SLPsItem',
    'SPEI_ADAPTATION', 'DISPID_SPARecoResult', 'SPFM_CREATE',
    'DISPID_SVPause', 'SAFTCCITT_uLaw_11kHzMono', 'SREAllEvents',
    'SDKLCurrentUser', 'ISpeechDataKey',
    'DISPID_SRGCmdLoadFromMemory', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPIRule', 'SpeechCategoryRecognizers',
    'DISPID_SLGetWords', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechPhraseAlternate', 'DISPID_SGRSTWeight',
    '_ISpeechRecoContextEvents', 'SAFTText', 'SpeechWordType',
    'DISPID_SpeechWaveFormatEx', 'SPPS_RESERVED3',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SASNonBlockingIO',
    'SDTLexicalForm', 'SPCS_DISABLED', 'ISpRecognizer', 'SPRULE',
    'SPXRO_SML', 'SAFTCCITT_uLaw_11kHzStereo', 'SPCATEGORYTYPE',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechLexiconPronunciation',
    'SPEI_END_INPUT_STREAM', 'SPBO_TIME_UNITS', 'SP_VISEME_4',
    'SAFT11kHz16BitMono', 'SPRS_ACTIVE_USER_DELIMITED',
    'tagSPPROPERTYINFO', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRGDictationSetState', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechObjectTokenCategory', 'SAFT48kHz16BitStereo',
    'ISpRecoGrammar', 'SPSEMANTICERRORINFO', 'DISPID_SOTs_NewEnum',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SDKDeleteValue',
    'SpeechCategoryRecoProfiles', 'DISPID_SAFType',
    'SPAUDIOBUFFERINFO', 'SPAS_CLOSED', 'SVSFIsFilename',
    'ISpeechLexiconWords', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SWFEBitsPerSample', 'SECLowConfidence', 'SPSVerb',
    'SAFTGSM610_8kHzMono', 'DISPID_SRGetPropertyString',
    'ISpeechRecognizer', 'SpeechRecognizerState', 'SRSInactive',
    'SPLOADOPTIONS', 'ISpXMLRecoResult', 'DISPID_SPCLangId',
    'SVSFDefault', 'SpNullPhoneConverter', 'SLODynamic',
    'DISPID_SRGId', 'ISpObjectWithToken', 'DISPID_SVGetAudioInputs',
    'SPGS_ENABLED', 'SP_VISEME_11', 'SPRST_ACTIVE', 'SpFileStream',
    'SpeechRegistryLocalMachineRoot', 'SGRSTTEpsilon', 'SPSMF_UPS',
    'SPEI_WORD_BOUNDARY', 'DISPID_SPIGetDisplayAttributes',
    'SRAONone', 'DISPID_SFSOpen', 'DISPID_SVSPhonemeId',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRSpeakAudio',
    'DISPID_SPEAudioSizeBytes', 'SpMMAudioOut', 'eLEXTYPE_MORPHOLOGY',
    'SPAR_Unknown', 'SP_VISEME_10', 'SDA_No_Trailing_Space',
    'SVSFParseMask', 'SRATopLevel', 'eLEXTYPE_VENDORLEXICON',
    'SVP_12', 'DISPID_SLWPronunciations',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRCEAdaptation',
    'DISPID_SRGState', 'SAFT11kHz8BitStereo', 'SVSFParseAutodetect',
    'SPRULESTATE', 'DISPID_SRGReset', 'SPEVENTENUM',
    ...
    'SPWORDLIST', 'SAFT12kHz16BitMono', 'DISPID_SVSkip',
    'DISPID_SRCRecognizer', 'SAFT8kHz8BitStereo',
    'SPWORDPRONOUNCEABLE', 'IEnumSpObjectTokens',
    'SpeechTokenContext', 'DISPID_SGRSTPropertyName', 'SpShortcut',
    'DISPID_SpeechPhraseInfo', 'SpeechAudioFormatGUIDWave',
    'ISpeechRecoResult2', 'SPPS_Verb', 'ISpSerializeState',
    'SPCS_ENABLED', 'SPWAVEFORMATTYPE',
    'DISPID_SRSSupportedLanguages', 'SAFT24kHz8BitMono',
    'ISpeechLexiconPronunciations', 'SAFTADPCM_11kHzStereo',
    'SPVISEMES', 'DISPID_SRCEEndStream', 'DISPID_SpeechRecoResult2',
    'SpeechTokenValueCLSID', 'ISpeechGrammarRule',
    'SPEI_RECO_STATE_CHANGE', 'tagSTATSTG',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SREFalseRecognition',
    'SP_VISEME_16', 'DISPID_SRCEventInterests', 'DISPID_SRProfile',
    'SPEI_UNDEFINED', 'DISPID_SpeechBaseStream', 'SSTTTextBuffer',
    'SDTAudio', 'DISPID_SRCBookmark', 'eLEXTYPE_RESERVED8',
    'DISPID_SRGDictationUnload', 'SPAUDIOSTATE',
    'DISPID_SOTIsUISupported', 'DISPID_SRCPause',
    'SAFTGSM610_22kHzMono', 'SAFTCCITT_uLaw_8kHzMono', 'SPWT_LEXICAL',
    'SPVPRI_ALERT', 'DISPID_SPAs_NewEnum', 'SP_VISEME_14',
    'SpeechGrammarRuleStateTransitionType', 'SpeechRegistryUserRoot',
    'SPEI_RESERVED3', 'ISpeechRecoResultDispatch',
    'DISPID_SRCCreateGrammar', 'DISPID_SPPConfidence',
    'SAFT12kHz8BitMono', 'SPWF_SRENGINE', 'DISPID_SOTCreateInstance',
    'ISpeechFileStream', 'SRTExtendableParse',
    'DISPID_SpeechPhoneConverter', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPCPhoneToId',
    'SVEPrivate', 'SGDisplay', 'DISPID_SGRSTRule',
    'DISPID_SRRTLength', 'SRSActive',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRsAdd',
    'SPPS_RESERVED2', 'SPLO_DYNAMIC', 'SPGS_DISABLED',
    'SpeechRuleAttributes', 'STCInprocHandler',
    'DISPID_SRRGetXMLErrorInfo', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechAudioBufferInfo', 'Speech_Max_Word_Length', 'SDTAll',
    'SVP_4', 'DISPID_SOTCDefault', 'SAFTCCITT_uLaw_44kHzMono',
    'SECFIgnoreKanaType', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCRetainedAudio', 'SPPS_Unknown', 'STSF_CommonAppData',
    'SPINTERFERENCE_NOSIGNAL', 'SPDKL_LocalMachine',
    'ISpeechPhraseRules', 'SPEI_MAX_TTS', 'SPTEXTSELECTIONINFO',
    'DISPID_SVEBookmark', 'SVP_10', 'SGSExclusive', 'SPPS_RESERVED1',
    'DISPID_SAFSetWaveFormatEx', 'SpUnCompressedLexicon',
    'SPSHT_EMAIL', 'SREStateChange', 'SREAudioLevel',
    'SPADAPTATIONRELEVANCE', 'DISPID_SOTSetId', 'SPEI_VOICE_CHANGE',
    'DISPID_SAEventHandle', 'SP_VISEME_19', 'SVP_2', 'SASClosed',
    'ISpeechObjectTokenCategory', 'SPSNotOverriden',
    'DISPID_SGRSTsItem', 'SRSInactiveWithPurge', 'SP_VISEME_1',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SDKEnumValues',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPRules_NewEnum',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCERecognition',
    'SVSFIsNotXML', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRRTTickCount', 'DISPID_SWFESamplesPerSec',
    'DISPID_SLWsItem', 'SPSSuppressWord', 'SP_VISEME_20',
    'SpeechDiscardType', 'DISPID_SGRsCommitAndSave',
    'Speech_Default_Weight', 'DISPID_SWFEFormatTag',
    'DISPID_SPEActualConfidence', 'DISPID_SLGetGenerationChange',
    'DISPID_SLWs_NewEnum', 'SPEI_MIN_TTS',
    'DISPID_SVSInputWordLength', 'DISPID_SGRClear',
    'DISPID_SPRFirstElement', 'SVSFlagsAsync', 'SVP_19',
    'DISPID_SPIElements', 'SVEBookmark', 'SPEI_SOUND_START',
    'SAFT22kHz16BitStereo', 'DISPID_SRGetRecognizers',
    'DISPID_SPRs_NewEnum', 'SP_VISEME_15', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_RESERVED10', 'DISPIDSPRG', 'SAFT12kHz16BitStereo',
    'SRERecoOtherContext', 'eLEXTYPE_PRIVATE17',
    'SpeechEngineConfidence', 'DISPID_SRRGetXMLResult',
    'SpPhoneConverter', 'ISpGrammarBuilder',
    'DISPID_SpeechVoiceEvent', 'SGRSTTRule', 'ISpeechPhraseInfo',
    'IInternetSecurityManager', 'IStream', 'SRCS_Disabled',
    'DISPID_SRDisplayUI', 'SpeechStreamSeekPositionType',
    'SREAdaptation', 'DISPID_SPRuleParent', 'DISPID_SRRSaveToMemory',
    'ISpeechRecoResult', 'SPRS_ACTIVE', 'DISPID_SASState',
    'ISpeechWaveFormatEx', 'SpeechGrammarTagUnlimitedDictation',
    'SPDKL_CurrentUser', 'DISPID_SPRsCount', 'ISpeechPhraseElements',
    'SPPS_RESERVED4', 'SAFT22kHz16BitMono', 'SSSPTRelativeToEnd',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SVSVisemeId', 'SVPOver', 'SVEViseme', 'SGLexical',
    'ISpRecognizer2', 'SVEVoiceChange', 'DISPID_SCSBaseStream',
    'SRSActiveAlways', 'DISPID_SPERetainedStreamOffset',
    'ISpPhoneConverter', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_MAX_SR',
    'SWPUnknownWordUnpronounceable', 'DISPID_SDKGetStringValue',
    'SWTDeleted', 'DISPID_SRCEEnginePrivate', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_PRIVATE15', 'DISPID_SLPs_NewEnum', 'DISPID_SPRuleName',
    'SpSharedRecognizer', 'eLEXTYPE_RESERVED6',
    'SAFT24kHz16BitStereo', 'DISPID_SOTsItem', 'SRERequestUI',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRTAutopause',
    'ISpeechCustomStream', 'SpeechVoiceSkipTypeSentence',
    'SpCompressedLexicon', 'DISPID_SRRecognizer',
    'SAFT12kHz8BitStereo', 'ISpDataKey', 'SECFIgnoreWidth',
    'DISPID_SPRuleConfidence', 'DISPID_SGRsCount', 'SPLEXICONTYPE',
    'ISpEventSink', 'DISPID_SPRulesCount', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPIEnginePrivateData', 'SPDKL_DefaultLocation',
    'eLEXTYPE_PRIVATE16', 'SFTInput', 'DISPID_SGRAddState',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SVStatus',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTDataKey',
    'DISPID_SVSRunningState', 'SpeechAudioState',
    'DISPID_SRCRetainedAudioFormat', 'Speech_StreamPos_Asap',
    'DISPID_SVResume', 'DISPID_SRRAlternates', 'SPEI_TTS_BOOKMARK',
    'ISpAudio', 'ISpPhoneticAlphabetConverter', 'SpeechAudioVolume',
    'DISPID_SPEAudioTimeOffset', 'SRTStandard', 'DISPID_SPRsItem',
    'SpeechAudioFormatGUIDText', 'DISPID_SVEWord',
    'DISPID_SPPs_NewEnum', 'SPXMLRESULTOPTIONS',
    'ISpeechMemoryStream', 'DISPID_SRCRequestedUIType',
    'SWPUnknownWordPronounceable', 'DISPID_SPELexicalForm',
    'DISPID_SpeechPhraseReplacements', 'IEnumString',
    'eLEXTYPE_PRIVATE2', 'SPWF_INPUT', 'DISPID_SPERequiredConfidence',
    'ISpeechPhraseReplacement', 'DISPID_SRGDictationLoad',
    'SpeechUserTraining', 'SPEI_RESERVED6', 'DISPID_SOTsCount',
    'SDTProperty', 'DISPID_SVEAudioLevel',
    'DISPID_SVESentenceBoundary', 'DISPID_SGRSTsCount',
    'SPEI_RESERVED1', 'SPPHRASEREPLACEMENT', 'STCInprocServer',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSRule', 'DISPID_SpeechPhraseProperty',
    'SpeechEngineProperties', 'SAFT16kHz16BitMono', 'SVP_11',
    'SpeechTokenIdUserLexicon', 'DISPIDSPTSI_SelectionLength',
    'SPSInterjection', 'DISPID_SAFGuid', 'DISPID_SPIStartTime',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpShortcut', 'SAFT32kHz16BitMono',
    'DISPID_SPEPronunciation', 'SREPropertyNumChange',
    ...
    'SpeechAudioProperties', 'DISPID_SPRuleEngineConfidence',
    'SASStop', 'ISpeechPhoneConverter', 'ISpProperties',
    'DISPID_SpeechPhraseAlternates', 'SPVPRI_OVER', 'SPEI_MIN_SR',
    'ISpLexicon', 'SAFTCCITT_uLaw_22kHzStereo', 'SPSNoun',
    'SPGS_EXCLUSIVE', 'SREBookmark', 'DISPID_SDKGetlongValue',
    'SpeechGrammarWordType', 'ISpPhrase', 'DISPID_SPIAudioSizeTime',
    'SAFT11kHz16BitStereo', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechRecoResult', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechXMLRecoResult', 'SPPS_SuppressWord',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPPsItem',
    'SECFIgnoreCase', 'SPBOOKMARKOPTIONS', 'SVF_Stressed',
    'SPAS_STOP', 'DISPID_SGRSTPropertyId',
    'DISPID_SVSpeakCompleteEvent', 'SpeechStreamFileMode',
    'SPSHT_NotOverriden', 'DISPID_SRGRecoContext',
    'SpeechCategoryAudioIn', 'eLEXTYPE_APP', 'DISPID_SRCEHypothesis',
    'SPSModifier', 'SDKLCurrentConfig', 'SpeechDataKeyLocation',
    'SpWaveFormatEx', 'SpCustomStream', 'ISpeechRecoContext',
    'DISPID_SpeechAudioStatus', 'DISPID_SRGRules',
    'DISPID_SpeechLexiconPronunciation', 'SPEVENT', 'ISpRecoContext',
    ...
    'ISpeechPhraseElement', 'DISPID_SBSRead', 'SPSEMANTICFORMAT',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPIAudioStreamPosition',
    'ISpeechAudioStatus', 'DISPID_SGRName', 'SPPS_Noncontent',
    'SPGRAMMARSTATE', 'DISPID_SDKSetBinaryValue', 'DISPID_SASetState',
    'ISpeechRecoResultTimes', 'SPFM_OPEN_READONLY', 'SPEI_SR_PRIVATE',
    'DISPID_SPPId', 'SAFTExtendedAudioFormat',
    'Speech_StreamPos_RealTime', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SpeechGrammarRule', 'SLTUser', 'SpeechRunState',
    'DISPID_SVSLastBookmarkId', 'SpeechVoicePriority', 'SPAR_Medium',
    'SREStreamEnd', 'DISPID_SPRNumberOfElements',
    'DISPID_SRGSetTextSelection', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCESoundStart', 'SP_VISEME_0', 'ISpNotifySource',
    'DISPID_SFSClose', 'DISPID_SpeechPhraseRules',
    'SAFT24kHz8BitStereo', 'SpObjectTokenCategory',
    'DISPID_SRIsShared', 'SpeechRecognitionType',
    'DISPID_SVGetAudioOutputs', 'SBOPause', 'DISPID_SBSFormat',
    'SAFT32kHz16BitStereo', 'SPSHT_OTHER', 'SAFT44kHz16BitMono',
    'ISpeechPhraseProperty', 'SPRECOSTATE', 'SVP_3', 'SPCT_COMMAND',
    'DISPID_SDKOpenKey', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPAsItem', 'SPCT_SUB_COMMAND', 'SAFT11kHz8BitMono',
    'SAFTADPCM_8kHzMono', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPEEngineConfidence', 'SAFTCCITT_ALaw_22kHzMono',
    'SVP_21', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPRDisplayAttributes', 'SGDSActiveUserDelimited',
    'SPVPRI_NORMAL', 'SpPhraseInfoBuilder', 'SVP_5',
    'SDA_Consume_Leading_Spaces', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPRECORESULTTIMES', 'SPDATAKEYLOCATION', 'SPBO_PAUSE',
    'WAVEFORMATEX', 'DISPID_SRRAudioFormat', 'DISPID_SVSLastBookmark',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT44kHz8BitMono', 'SLTApp',
    'SAFT16kHz16BitStereo', 'SpeechGrammarState', 'SPSFunction',
    ...
    'DISPID_SOTGetAttribute', 'SVP_13', 'SVESentenceBoundary',
    'SPPS_Interjection', 'DISPID_SVAlertBoundary', 'SPSHORTCUTPAIR',
    'ISpeechGrammarRules', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechObjectToken', 'SAFTADPCM_22kHzStereo',
    'SpeechPropertyLowConfidenceThreshold', 'SPAS_RUN', 'ISpStream',
    'DISPID_SASFreeBufferSpace', 'SPWORDPRONUNCIATION',
    'DISPID_SLWWord', 'DISPID_SpeechMMSysAudio', 'ISpeechPhraseRule',
    'STCRemoteServer', 'eWORDTYPE_DELETED', 'ISpStreamFormat',
    'DISPID_SVSInputWordPosition', 'SAFTADPCM_22kHzMono', 'SASRun',
    'DISPID_SpeechRecognizer', 'DISPID_SABIMinNotification',
    'SVSFPersistXML', 'DISPID_SPIGrammarId', 'SpObjectToken',
    'SRADefaultToActive', 'SPAUDIOSTATUS', 'DISPID_SVAudioOutput',
    'DISPID_SPRulesItem', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEInterference', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFT48kHz16BitMono', 'DISPID_SPPChildren',
    'SpeechPropertyAdaptationOn', 'SpeechRuleState',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSTText',
    ...
    'ISpeechObjectToken', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_PRIVATE7', 'eWORDTYPE_ADDED', 'eLEXTYPE_PRIVATE18',
    'DISPID_SWFEChannels', 'SVP_9', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRSAudioStatus',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFT48kHz8BitStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechInterference',
    'SPSHORTCUTPAIRLIST', 'DISPID_SVVoice',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE6',
    'SSFMOpenReadWrite', 'DISPID_SpeechFileStream',
    'DISPID_SpeechPhraseElements', 'SLOStatic', 'SVPNormal',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechRecoContextEvents',
    'eLEXTYPE_RESERVED4', 'SpeechRecoEvents', 'eLEXTYPE_PRIVATE10',
    'SAFTCCITT_ALaw_44kHzMono', 'SITooSlow',
    'DISPID_SRCCreateResultFromMemory', 'STCAll', 'ISpNotifySink',
    ...
    'SPEVENTSOURCEINFO', 'SpVoice', 'SpeechAddRemoveWord',
    'DISPID_SPAsCount', 'ISpVoice', 'SpSharedRecoContext',
    'SREStreamStart', 'SECFNoSpecialChars', 'SVP_6',
    'DISPID_SRSCurrentStreamNumber', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechAudioFormat', 'DISPID_SASCurrentDevicePosition',
    'ISpeechPhraseAlternates', 'SSFMCreate', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechVoiceStatus', 'SVP_8', 'DISPID_SGRAddResource',
    'SAFTGSM610_11kHzMono', 'SRAExport', 'DISPID_SRCreateRecoContext',
    'DISPID_SVEStreamStart', 'SVP_15', 'eLEXTYPE_PRIVATE12',
    'SDA_One_Trailing_Space', 'SAFT8kHz16BitStereo', 'SPRS_INACTIVE',
    'SPINTERFERENCE_TOOFAST', 'SVP_1', 'ISpeechRecoGrammar',
    'DISPID_SGRsDynamic', 'DISPID_SDKGetBinaryValue',
    'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_8',
    'DISPID_SVEventInterests', '_SPAUDIOSTATE', 'SPINTERFERENCE',
    'DISPID_SPIReplacements', 'DISPID_SRGCommit',
    'SPFM_CREATE_ALWAYS', 'SPFILEMODE', 'SpeechVoiceEvents',
    'SpMemoryStream', 'DISPID_SpeechObjectTokens', 'SRSEIsSpeaking',
    'DISPID_SABIEventBias', 'DISPID_SRCSetAdaptationData',
    'DISPID_SAStatus', 'SpeechGrammarTagDictation',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SOTGetDescription',
    'DISPID_SRCEPropertyStringChange', 'SVSFParseSapi',
    'SpeechDictationTopicSpelling', 'DISPID_SBSSeek',
    'ISpObjectTokenCategory', 'SpeechVoiceSpeakFlags',
    'SAFTADPCM_11kHzMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPDKL_CurrentConfig', 'SPEI_SR_BOOKMARK', 'DISPID_SMSGetData',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechAudio', 'SAFT22kHz8BitStereo',
    'SRAORetainAudio', 'SVEEndInputStream', 'DISPID_SLGenerationId',
    'DISPID_SDKEnumKeys', 'STSF_AppData', 'SWTAdded',
    'SPRST_ACTIVE_ALWAYS', 'SPWORDTYPE', 'DISPID_SRCState',
    'SpInProcRecoContext', 'SPCT_SUB_DICTATION', 'SGSDisabled',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRState',
    'DISPID_SpeechRecognizerStatus', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVEEnginePrivate', 'DISPID_SVPriority', 'SITooLoud',
    'SPPROPERTYINFO', 'DISPID_SABufferNotifySize', 'ISpeechVoice',
    'SINone', 'SAFTADPCM_44kHzMono', 'ISpRecoGrammar2',
    'DISPID_SVGetProfiles', 'SPRECOCONTEXTSTATUS', 'DISPID_SAVolume',
    'SPSHT_Unknown', 'SRESoundStart', 'SPSERIALIZEDPHRASE',
    'SDKLDefaultLocation', 'SPXRO_Alternates_SML',
    'SPEI_INTERFERENCE', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPPValue', 'DISPID_SMSAMMHandle',
    'DISPID_SRRSetTextFeedback', 'SDTAlternates', 'UINT_PTR',
    'SBONone', 'SpeechCategoryAudioOut',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPEDisplayText', 'DISPID_SpeechPhraseElement',
    'SPEI_START_SR_STREAM', 'SVEPhoneme', 'SPWT_PRONUNCIATION',
    'DISPID_SPRuleId', 'DISPID_SPPsCount',
    'DISPID_SRGIsPronounceable', 'SGPronounciation', 'DISPID_SVSpeak',
    'DISPID_SRGetPropertyNumber', 'ISpNotifyTranslator',
    'SAFTNoAssignedFormat', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SDKDeleteKey', 'DISPID_SVGetVoices',
    'SGLexicalNoSpecialChars', 'SRCS_Enabled', 'SPPHRASEPROPERTY',
    'SAFT8kHz16BitMono', 'SSTTWildcard', 'DISPID_SMSADeviceId',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRsFindRule', 'STCLocalServer',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SOTRemove',
    'DISPID_SpeechDataKey', 'ISpeechMMSysAudio',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_17',
    'DISPID_SLPPhoneIds', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SGRSTType', 'SpeechFormatType'
]
